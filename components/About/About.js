        ...
        <div className={`section ${styles.about_me}`}>
            ...
            <div className={styles.story}>
                ...
                <div className={styles.story_text}>
                    ...
                    <div>
                        <button onClick={handleClick} className={shown ? styles.hide : styles.btn}> Read on!</button>
                    </div>
                    ...
                    <button onClick={handleClick} className={shown ? styles.btn : styles.hide}> Done Reading!</button>
